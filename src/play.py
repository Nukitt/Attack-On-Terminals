...
class game:
    ...
    def __init__(self):   
        ...
        while viewbase:
            ...
            user_input = input.input_to(input.Get(),1)
            ...
            if user_input != None:
                if user_input == 'q':
                    ...
                    # self.movebarb(base,self.buildings,self.ragemultiplier)
    ...
    # def movebarb(self,base,enemy,multiplier):
    #     if self.y > 2 and base[self.x][self.y -1] == Back.GREEN + ' ':
    #         if multiplier==2:
    #             if base[self.x][self.y -2] == Back.GREEN + ' ':
    #                 self.y -= 2
    #             else:
    #                 self.y -= 1
    #         else:
    #             self.y -= 1
    #     elif self.y < 234 and base[self.x][self.y +1] == Back.GREEN + ' ':
    #         if multiplier==2:
    #             if base[self.x][self.y +2] == Back.GREEN + ' ':
    #                 self.y += 2
    #             else:
    ...
    #         else:
    #             self.y += 1
    #     elif self.x > 2 and base[self.x -1][self.y] == Back.GREEN + ' ':
    #         if multiplier==2:
    #             if base[self.x -2][self.y] == Back.GREEN + ' ':
    #                 self.x -= 2
    #             else:
    #                 self.x -= 1
    #         else:
    #             self.x -= 1
    #     elif self.x < 59 and base[self.x +1][self.y] == Back.GREEN + ' ':
    #         if multiplier==2:
    #             if base[self.x +2][self.y] == Back.GREEN + ' ':
    #                 self.x += 2
    #             else:
    ...
    def showbase(self,cols,rows,base,king):
        ...
        for troop in self.troops:
            ...
            # if isinstance(troop,characters.king):
            #     health=troop.health
            #     if health<=0:
            #         print("You lose")
            #         sys.exit()
        ...
        for i in range(rows):
            for j in range(cols):
                ...
                if king.health<=0:
                    os.system('clear')
                    print("You lose")
                    replayname = builtins.input("Save the replay file as(put .txt at end): ")
                    replayname = "replays/"+replayname
                    file = open(replayname,"w")
                    for i in range(len(self.moves)):
                        file.write(str(self.moves[i]))
                        file.write("\n")
                    sys.exit()
